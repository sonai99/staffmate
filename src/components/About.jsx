  ...
  return (
    <div class="bg-[#f8fafc]">
        ...
        <div class="mt-4 md:mt-0">
            ...
            <a href="/demo" class="inline-flex items-center text-white bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                Check Demo
